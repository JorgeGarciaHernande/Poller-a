...
import 'package:polleriaproyecto/main.dart';
import 'package:shared_preferences/shared_preferences.dart'; // Importado para manejar tokens
...
import '/Vistas/LoginView.dart'; // Asegúrate de que tengas esta vista
...
class TicketsMenu extends StatelessWidget {
  ...
  Future<void> _cerrarSesion(BuildContext context) async {
    ...
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => const MainApp()), // Redirige al login
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(
            ...
            color: Colors.white, // Estilo rojo para "Pollos Chava"
          ),
        ),
        actions: [
          IconButton(
