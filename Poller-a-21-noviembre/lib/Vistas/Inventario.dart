            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  width: 50,
                  height: 50,
                  child: Image.network('https://via.placeholder.com/150'), // Reemplaza esto por una URL de imagen real si la tienes
                ),
              ],
            ),
          ),
                          ...
                          child: Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                Expanded(
                                  child: Image.network(
                                    item['imagen'] ?? 'https://via.placeholder.com/150', // Solo URL de imagen
                                    fit: BoxFit.cover,
                                  ),
                                ),
