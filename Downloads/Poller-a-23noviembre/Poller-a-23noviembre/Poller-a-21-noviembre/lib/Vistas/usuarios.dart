...
class _UsuarioPageState extends State<UsuarioPage> {
  ...
  String _rolSeleccionado = 'usuario'; // Valor predeterminado
  ...
  Future<void> _agregarUsuario(String username, String password, String rol) async {
    if (username.isEmpty || password.isEmpty) {
      return;
    }
    await _usuarioController.agregarUsuario(username: username, password: password, rol: rol);
    await _cargarUsuarios();
  }

  Future<void> _editarUsuario(String docId, String username, String password, String rol) async {
    if (username.isEmpty || password.isEmpty) {
      return;
    }
    await _usuarioController.editarUsuario(docId, username: username, password: password, rol: rol);
    await _cargarUsuarios();
  }
                    ...
                    Expanded(
                      child: DropdownButton<String>(
                        ...
                        onChanged: (String? nuevoRol) {
                          setState(() {
                            _rolSeleccionado = nuevoRol ?? 'usuario';
                          });
                        },
                      ),
                    ),
  ...
  void _mostrarFormularioEditarUsuario(String docId, String username, String password, String rol) {
    final _formKey = GlobalKey<FormState>();
          ...
          content: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Campo de selección de rol para la edición
                Row(
                  children: [
                    const Text('Rol: '),
                    Expanded(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('ID: ${usuario['id']}, Rol: ${usuario['rol']}'),
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              _mostrarFormularioEditarUsuario(usuario['id'], usuario['username'], usuario['password'], usuario['rol']);
                            },
                          ),
                          IconButton(
